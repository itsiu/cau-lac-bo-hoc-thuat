...
frm.submit(function (e) {
    ...
    if (recaptcha === "") {
        ...
        $.ajax({
            ...
            url: 'https://script.google.com/macros/s/AKfycbzjRfUpAdX5rG6r2m9J07tW_Hr3IDqQnyXgdyR27qhybTh7rjs/exec',
            data: frm.serialize(),
...
var countDownDate = new Date("Sep 18, 2019 23:59:59").getTime();
